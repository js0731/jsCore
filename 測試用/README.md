...
<p>
    作用域又分為<strong>語法作用域</strong>跟<strong>動態作用域</strong>前者指的是函數的作用域在一開始就已經確定了，而後者指的是呼叫函數時才會決定作用域，而<strong>javascript</strong>所採用的是<strong>語法作用域(又稱為靜態作用域</strong>
  </p>
